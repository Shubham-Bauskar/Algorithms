...
int main()
{
    ...
    for(i=0;i<n;i++)
        visited[i]=0; // 0=Not Processed 1=Waiting in Stack 2=Processed
    printf("Enter the Source && Destination Vertex:-\n");
    int s,d;
    scanf("%d%d",&s,&d);
    int stack[n],top=-1,temp,found=0;
    stack[++top]=s;
    ...
    while(top!=-1)
    {
        ...
        else // Put all the Adjacent nodes of Temp into the Stack whose visited status=0
        {
